...
namespace SDS.Migrations.SDSAuth
{
    ...
    [Migration("20220607151619_ajoutBasket")]
    partial class ajoutBasket
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SDS.Areas.Identity.Data.SDSUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("basketidBasket")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SDS.Areas.Identity.Data.SDSUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SDS.Areas.Identity.Data.SDSUser", b =>
                {
                    b.HasOne("SDS.Models.Basket", "basket")
                        .WithMany()
            ...
            modelBuilder.Entity("SDS.Models.Course", b =>
                {
                    b.HasOne("SDS.Models.Basket", null)
                        .WithMany("courses")
                        .HasForeignKey("BasketidBasket");
                });
